    ...
    <div className="md">
      <ReactMarkdown
        ...
        components={{
          ...
          h1: (p) => <h2 className="mt-4 mb-2 text-base font-semibold first:mt-0" {...p} />,
          h2: (p) => <h3 className="mt-4 mb-2 text-base font-semibold first:mt-0" {...p} />,
          h3: (p) => <h4 className="mt-3 mb-1.5 text-sm font-semibold first:mt-0" {...p} />,
          h4: (p) => <h5 className="mt-3 mb-1.5 text-sm font-semibold first:mt-0" {...p} />,
          ...
          pre: (p) => (
            <pre
              className="my-2 overflow-x-auto rounded-lg border border-gray-700 bg-gray-950 p-3 font-mono text-xs leading-relaxed [&>code]:border-0 [&>code]:bg-transparent [&>code]:p-0 [&>code]:text-gray-200"
              {...p}
            />
          ),
          table: (p) => (
          ...
          th: (p) => (
            <th className="border-b border-gray-700 px-2.5 py-1.5 text-left font-semibold" {...p} />
          ),
          td: (p) => <td className="border-b border-gray-800 px-2.5 py-1.5 align-top" {...p} />,
        }}
      >
        {children}
      </ReactMarkdown>
